// lib/features/inventory_check/data/models/inventory_item_model.dart
...
class InventoryItemModel extends InventoryItemEntity {
  ...
  @JsonKey(name: 'zc_warehouse_qty_out', defaultValue: 0.0, fromJson: _qtyFromJson)
  double get getzcWarehouseQtyExport => zcWarehouseQtyExport;
  
  @JsonKey(name: 'zc_inventory', defaultValue: '')
  String get getZcInventory => zcInventory;
